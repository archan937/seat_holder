...
// *
// * $Date: 2010-08-29 12:38:36 +0100 (Sun, 29 August 2010) $
// *
...
(function () {
  ...
  if (missing_libs.length == 0) {
    ...
    var src = scriptElement.getAttribute("src").replace(/(development\/)?(\w+)(\-min)?\.js.*$/, "jquery/" + missing_libs.sort().join(".") + ".js");
